...
public class JDBC {
	...
	private static final String DRIVERCLASS = "com.microsoft.sqlserver.jdbc.SQLServerDriver"; // 数据库驱动
	// 路径
	private static final String URL = "jdbc:sqlserver://127.0.0.1:1433;DatabaseName=RestaurantManage";
